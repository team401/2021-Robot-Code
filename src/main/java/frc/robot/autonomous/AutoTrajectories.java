...
public class AutoTrajectories {
    ...
    public AutoTrajectories() {
        ...
        autoNavBarrelTrajectory = TrajectoryGenerator.generateTrajectory(
            new Pose2d(Units.inchesToMeters(48.5), Units.inchesToMeters(90), new Rotation2d(0)),
            List.of(new Translation2d(Units.inchesToMeters(150), Units.inchesToMeters(90)),
                    ...
                    new Translation2d(Units.inchesToMeters(295), Units.inchesToMeters(61.5)),
                    new Translation2d(Units.inchesToMeters(100), Units.inchesToMeters(61.5))),
            new Pose2d(Units.inchesToMeters(48.5), Units.inchesToMeters(61.5), new Rotation2d(0)), config);
    }
